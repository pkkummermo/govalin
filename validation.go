...
// StringValidator provides type-safe string validation 
func NewStringValidator() *validation.Validator[string] {
	return validation.Validate[string]()
}

// IntValidator provides type-safe integer validation
...
// Custom allows defining custom validation logic for strings
